...
- [**Feature Forge**](https://github.com/punt-labs/feature-forge) `Claude Code` — Multi-agent feature development from observation to implementation. Hive-mind consensus on PRDs, SPARC planning, and verified implementation with issue tracking integration.
