...
banner "biff"
curl -fsSL "$GH/biff/8064d32/install.sh" | sh

banner "quarry"
curl -fsSL "$GH/quarry/268c8ce/install.sh" | sh

banner "vox"
curl -fsSL "$GH/vox/cf2fd75/install.sh" | sh

banner "lux"
curl -fsSL "$GH/lux/f3bc9b9/install.sh" | sh

banner "ethos"
curl -fsSL "$GH/ethos/b379a79/install.sh" | sh
