...
banner "biff"
curl -fsSL "$GH/biff/3e6bf37/install.sh" | sh

banner "quarry"
curl -fsSL "$GH/quarry/fd274d3/install.sh" | sh

banner "vox"
curl -fsSL "$GH/vox/67b5ac4/install.sh" | sh

banner "lux"
curl -fsSL "$GH/lux/13101870/install.sh" | sh

banner "ethos"
curl -fsSL "$GH/ethos/abab3f6/install.sh" | sh

banner "z-spec"
curl -fsSL "$GH/z-spec/78d2f23/install.sh" | sh
