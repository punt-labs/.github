...
banner "beadle"
curl -fsSL "$GH/beadle/393ae89/install.sh" | sh

banner "biff"
curl -fsSL "$GH/biff/2b17553/install.sh" | sh

banner "quarry"
curl -fsSL "$GH/quarry/1c4c3c7/install.sh" | sh

banner "vox"
curl -fsSL "$GH/vox/7034f55/install.sh" | sh

banner "lux"
curl -fsSL "$GH/lux/3180aab/install.sh" | sh

banner "ethos"
curl -fsSL "$GH/ethos/590ae88/install.sh" | sh
