...
banner "beadle"
curl -fsSL "$GH/beadle/407fc12/install.sh" | sh

banner "biff"
curl -fsSL "$GH/biff/5ef62a3/install.sh" | sh

banner "quarry"
curl -fsSL "$GH/quarry/606d462/install.sh" | sh

banner "vox"
curl -fsSL "$GH/vox/ad2aa26/install.sh" | sh

banner "lux"
curl -fsSL "$GH/lux/00c88f6/install.sh" | sh

banner "ethos"
curl -fsSL "$GH/ethos/c826b65/install.sh" | sh

banner "z-spec"
curl -fsSL "$GH/z-spec/49e9e1b/install.sh" | sh
