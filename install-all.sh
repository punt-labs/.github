...
banner "punt-kit"
curl -fsSL "$GH/punt-kit/fa06959/install.sh" | sh

banner "beadle"
curl -fsSL "$GH/beadle/4cc7f6b/install.sh" | sh

banner "biff"
curl -fsSL "$GH/biff/298b545/install.sh" | sh

banner "quarry"
curl -fsSL "$GH/quarry/935c58d/install.sh" | sh
...
banner "ethos"
curl -fsSL "$GH/ethos/d013870/install.sh" | sh
