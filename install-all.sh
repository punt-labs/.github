...
banner "biff"
curl -fsSL "$GH/biff/0dfe5e3/install.sh" | sh

banner "quarry"
curl -fsSL "$GH/quarry/6f90f11/install.sh" | sh

banner "vox"
curl -fsSL "$GH/vox/956ea0b/install.sh" | sh

banner "lux"
curl -fsSL "$GH/lux/947e89a/install.sh" | sh

banner "ethos"
curl -fsSL "$GH/ethos/693a650/install.sh" | sh
