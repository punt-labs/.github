...
banner "beadle"
curl -fsSL "$GH/beadle/4cd53fe/install.sh" | sh

banner "biff"
curl -fsSL "$GH/biff/f807aa7/install.sh" | sh

banner "quarry"
curl -fsSL "$GH/quarry/fa18b25/install.sh" | sh

banner "vox"
curl -fsSL "$GH/vox/e750145/install.sh" | sh
